<!-- Collection delete confirmation design (plain HTML placeholders + embedded CSS) -->
...
<div class="content">
	...
	<div class="card-box">
		<p>Are you sure you want to delete <strong>Summer Specials</strong>? This action cannot be undone.</p>
