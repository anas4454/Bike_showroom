<x-dashboard-layout.main>
	...
	<style>
		...
		.card-box{background:#fff;border:1px solid #E5E7EB;border-radius:14px;padding:20px}
		...
		<div class="row g-3">
			...
			<div class="col-12">
				<div class="card-box">
					...
					<p class="text-muted">Listed product identifiers (stored in `productId`). If your controller passes related products, they will show here.</p>
						...
						<div class="table-responsive">
							<table class="table align-middle">
								...
								<tbody>
									...
									<tr>
										<td style="width:64px"><img src="{{ $p->thumb ?? '/images/placeholder.png' }}" style="width:64px;height:48px;object-fit:cover;border-radius:8px;border:1px solid #E5E7EB"></td>
										<td>{{ $p->name }}</td>
