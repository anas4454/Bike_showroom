<!-- Category edit design (plain HTML placeholders + local CSS) -->
		...
		<form action="#" method="POST">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<input class="form-control" name="name" value="Sports" />
				</div>

				<div class="col-12">
					<label class="form-label">Description</label>
					<textarea class="form-control" name="description" rows="3">High performance and track-ready motorcycles</textarea>
				</div>
