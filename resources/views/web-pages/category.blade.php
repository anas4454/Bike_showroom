...
<!-- CATEGORY HERO -->
<section class="py-5 text-white" style="background:#0B1C2D">
  <div class="container">
    <h1 class="fw-bold">Sports Bikes</h1>
    <p class="lead text-light mb-0">
      High-performance sports bikes built for speed, power, and style.
    </p>
  </div>
</section>
      ...
      <aside class="col-lg-3 mb-4">
        <div class="card shadow-sm border-0">
          <div class="card-body">
            ...
            <label class="small fw-bold mb-1">Engine Capacity</label>
            <select class="form-select mb-3">
              <option>All</option>
          ...
          <div class="col-md-4">
            <div class="card shadow-sm border-0 h-100">
              ...
              <img src="https://images.unsplash.com/photo-1612197590870-2e5d9d4c0c35"
                   ...
                   alt="Yamaha Sports Bike">
              <div class="card-body">
                <h6 class="fw-bold">Yamaha R15</h6>
                <p class="small text-muted mb-1">Engine: 155 CC</p>
                <p class="fw-bold text-warning">$1,850</p>
          ...
          <div class="col-md-4">
            <div class="card shadow-sm border-0 h-100">
              ...
              <img src="https://images.unsplash.com/photo-1558981403-c5f9891b6b87"
                   class="card-img-top"
                   style="height:220px; object-fit:cover;"
                   alt="Honda Sports Bike">
              <div class="card-body">
                <h6 class="fw-bold">Honda CBR 150R</h6>
          ...
          <div class="col-md-4">
            <div class="card shadow-sm border-0 h-100">
              ...
              <img src="https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f"
                   class="card-img-top"
                   style="height:220px; object-fit:cover;"
                   alt="Suzuki Sports Bike">
              <div class="card-body">
                <h6 class="fw-bold">Suzuki GSX-R 150</h6>
                <p class="small text-muted mb-1">Engine: 150 CC</p>
                <p class="fw-bold text-warning">$1,750</p>
                <a href="#" class="btn btn-outline-dark btn-sm w-100">View Details</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card shadow-sm border-0 h-100">
              ...
              <img src="https://images.unsplash.com/photo-1504215680853-026ed2a45def"
                   class="card-img-top"
                   style="height:220px; object-fit:cover;"
                   alt="Kawasaki Sports Bike">
              <div class="card-body">
                <h6 class="fw-bold">Kawasaki Ninja 250</h6>
                <p class="small text-muted mb-1">Engine: 250 CC</p>
                <p class="fw-bold text-warning">$2,600</p>
                <a href="#" class="btn btn-outline-dark btn-sm w-100">View Details</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card shadow-sm border-0 h-100">
              ...
              <img src="https://images.unsplash.com/photo-1595433562696-19f1c95fcb8a"
                   class="card-img-top"
                   style="height:220px; object-fit:cover;"
                   alt="Street Sports Bike">
              <div class="card-body">
                <h6 class="fw-bold">Street Sports Bike</h6>
                <p class="small text-muted mb-1">Engine: 180 CC</p>
                <p class="fw-bold text-warning">$1,650</p>
                <a href="#" class="btn btn-outline-dark btn-sm w-100">View Details</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card shadow-sm border-0 h-100">
              ...
              <img src="https://images.unsplash.com/photo-1605559424843-9e4c228bf1c3"
                   ...
                   alt="Racing Bike">
              <div class="card-body">
                <h6 class="fw-bold">Racing Edition Bike</h6>
                <p class="small text-muted mb-1">Engine: 200 CC</p>
                <p class="fw-bold text-warning">$1,400</p>
                <a href="#" class="btn btn-outline-dark btn-sm w-100">View Details</a>
              </div>
            </div>
          </div>
