                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="House no, street, area"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <img src="https://images.unsplash.com/photo-1558981403-c5f9891b6b87" width="70"
                                    class="rounded">
                                <div>
                                    <h6 class="fw-bold mb-0">Honda CB 150F</h6>
                                    <small class="text-muted">Qty: 1</small>
                                </div>
                                <span class="ms-auto fw-bold">$950</span>
                            </div>

                            <!-- Item -->
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <img src="https://images.unsplash.com/photo-1612197590870-2e5d9d4c0c35" width="70"
                                    class="rounded">
                                <div>
