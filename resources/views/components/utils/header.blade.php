   <header>
        ...
        <nav class="navbar navbar-expand-lg sticky-top" style="background:#0B1C2D">
            <div class="container">
                <a class="navbar-brand text-warning fw-bold fs-3" href="#">BIKE<span
                ...
                <div class="collapse navbar-collapse" id="nav">
                    <ul class="navbar-nav ms-auto gap-3">
                        <li class="nav-item"><a class="nav-link text-white" href="#">Home</a></li> <li class="nav-item"><a class="nav-link text-white" href="#">Bikes</a></li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-white" data-bs-toggle="dropdown">Categories</a>
                        ...
                        <li class="nav-item"><a class="btn btn-warning px-4" href="#">Cart</a></li>
                    </ul>
                </div>
            </div>
        </nav>
